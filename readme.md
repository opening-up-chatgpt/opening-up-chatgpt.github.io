# [![logo](docs/logos/openchatgpt-logo-favicon-red-on-transparent.png)](https:///opening-up-chatgpt.github.io/) Opening up ChatGPT — tracking openness in LLM + RLHF architectures — [view live tracker](https://opening-up-chatgpt.github.io/) 
